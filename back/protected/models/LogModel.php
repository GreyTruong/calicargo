...
class LogModel extends CFormModel {
    ...
    public function add($admin_id,$controller,$method,$ip,$description = ''){
        $time = time();
        $sql = "INSERT INTO logs(admin_id,access_controller,access_method,description,admin_ip,date_added) VALUES(:admin_id,:access_controller,:access_method,:description,:admin_ip,:date_added)";
        $command = Yii::app()->db->createCommand($sql);
