<section id="content" ng-controller="AddShipOrderCtrl" ng-init="init()">
  <section class="vbox">
    <section class="scrollable padder">             
      <div class="m-b-md">        
        <div id="msg_box"></div>
        <h3 class="m-b-none">Add Shipping Order</h3>
        ...
        <div ng-if="action_success" class="m-t alert alert-success alert-dismissible" role="alert">           
          <span class="col-xs-3">{{default_success_msg}}</span> <button class="btn btn-success" ng-click="newOrder()">Add another one</button>
        </div>      
                ...
                <div class="panel-body">                
                  ...
                  <div class="form-group" ng-repeat="i in items" id='item_group_{{i.id}}'>                       
                    ...
                    <div class="col-xs-1" style="padding-left:0;padding-bottom:0;padding-top:0;">                                 
                      <button class="col-xs-8 btn btn-sm btn-danger {{!canDelete ? 'disabled' : ''}}" 
                      ng-click='removeItem($event, i.id)'>
                        Delete
                      </button>
                      <span class="col-xs-3 text-right k-add-btn">
                        <a href="#" class="more-order-item" ng-click="addItem($event)"><i class="fa fa-plus-circle"></i></a>                    
                      </span>                    
                    </div>                                                            
                ...
                <div class="panel-body">                
                  ...
                  <div class="form-group">                                             
                    <div class="col-xs-5 text-left">
                      <?php foreach($util as $k => $v) : ?>
                      <label class="col-xs-4 k-nopad-left">
                        <input type="radio" name="order_type" value="<?php echo $k?>" checked>
                        <?php echo $v?>
                      </label>                                      
                      <?php endforeach; ?>                      
                    </div>                
                  ...
                  <div class="form-group">
                    <div class="col-xs-10"><input type="text" name="delivery_instruction" placeholder="Delivery Instruction" class='form-control'/></div> 
                    <label class="col-xs-2 text-right k-total-order">${{thisItem.total | number:2}}</label>
                  </div>                            
                </div>                  
              </section>
              <!--Submit Button-->
              <div class="col-xs-offset-4 col-xs-8 text-right" style="padding-bottom: 1em;">
