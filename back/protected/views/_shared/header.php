<!DOCTYPE html>
<html lang="en" class="app" ng-app="calicargo">
<head>
  <meta charset="utf-8" />
  ...
  <link rel="stylesheet" href="<?php echo HelperUrl::baseUrl()?>js/nestable/nestable.css" type="text/css" />
  <link rel="stylesheet" href="<?php echo HelperUrl::baseUrl()?>css/font.css" type="text/css" />
    <link rel="stylesheet" href="<?php echo HelperUrl::baseUrl()?>css/k-custom.css" type="text/css" />
      <link rel="stylesheet" href="<?php echo HelperUrl::baseUrl()?>css/chosen.css" type="text/css" />
