        ...
        <div class="panel-body">
            <form enctype="multipart/form-data" class="form-horizontal" method="post">
                        ...
                        <?php foreach ($languages as $k => $l): ?>
                            <div class="tab-pane fade in <?php echo $k == 0 ? 'active' : '' ?>" id="lang-<?php echo $l['id'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="<?php echo $l['id'] ?>[title]" id="input-id-1" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="<?php echo $l['id'] ?>[slug]" id="input-id-1" value="">
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="code" id="input-id-1" value="<?php echo isset($_POST['code']) ? $_POST['code'] : '' ?>">
                    </div>
                </div>
