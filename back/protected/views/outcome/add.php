...
<section id="content" ng-controller="AddShipOrderCtrl" ng-init="init()">
  <section class="vbox">
    <section class="scrollable padder">             
      <div class="m-b-md">        
        <h3 class="m-b-none">Add Outcome</h3>
        <div class="row" id="row">        
            <input type="hidden" value="<?php HelperUrl::BaseUrl(); ?>" id="base-url" />
            <form id="add_outcome" class="form-horizontal outcome-form" role="form">
                <section class="panel panel-default">          
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-5">
                                <input type="text" class="form-control" name="type" id="number" placeholder="Oucome type">
                            </div>
                            <label class="col-xs-2 k-control-label">Value</label>
                            <div class="col-xs-2">
                                <input type="number" step="any" class="form-control" name="value" id="value" placeholder="Value">
                            </div>
                        </div>
                        ...
                        <div class="form-group mb0">
                            ...
                            <div class="col-xs-8 text-right">
                              ...
                              <button type="submit" class="btn btn-success" style="min-width:80px; margin-left:10px;">Create</button>
                            </div>
                        </div>
                    </div>
                </section>
