...
class CategoryController extends Controller {
    ...
    public function actionIndex($type ='all',$p = 1) {
        ...
        $this->viewData['paging'] = $total_category > $ppp ? HelperApp::get_paging($ppp, HelperUrl::baseUrl() . "category/index/type/$type/p/", $total_category, $p) : "";
    ...
    private function do_add() {
        ...
        $this->redirect(HelperUrl::baseUrl() . "category/edit/id/$category_id/?s=1");
    }
    ...
    private function do_edit($category) {
        ...
        if (!$this->validator->is_empty_string($file['name'])) {
            $resize = HelperApp::resize_images($file, HelperApp::get_category_sizes(),$img);
            $img = $resize['img'];
            $thumbnail = $resize['thumbnail'];
        }
        ...
        $this->redirect(HelperUrl::baseUrl() . "category/edit/id/$category[id]/?s=1");
    }
